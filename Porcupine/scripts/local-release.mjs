...
const packages = [
	{ directory: "packages/ai", name: "@porcupineai/ai" },
	{ directory: "packages/tui", name: "@porcupineai/tui" },
	{ directory: "packages/agent", name: "@porcupineai/agent-core" },
	{ directory: "packages/protocol", name: "@porcupineai/protocol" },
	{ directory: "packages/client", name: "@porcupineai/client" },
	{ directory: "packages/storage/sqlite-node", name: "@porcupineai/storage-sqlite-node" },
	{ directory: "packages/coding-agent", name: "@porcupineai/coding-agent" },
];
