...
function convertToolResultContent(content: (TextContent | ImageContent | AudioContent)[]): ToolResultContentBlock[] {
	...
	for (const c of content) {
		...
		// audio blocks are dropped for this (text/image) API
	}
