...
/** Audio block for models with native audio input (same pattern as images). */
...
export interface ToolResultMessage<TDetails = any> {
	...
	toolCallId: string;
	toolName: string;
	content: (TextContent | ImageContent | AudioContent)[]; // Supports text, images, and audio
	details?: TDetails;
...
export type ImagesInputContent = TextContent | ImageContent | AudioContent;
export type ImagesOutputContent = TextContent | ImageContent | AudioContent;
