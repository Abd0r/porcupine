...
See [AGENTS.md](https://github.com/Abd0r/porcupine/blob/main/Porcupine/AGENTS.md) for additional guidelines.
...
`/debug` (hidden) writes to `~/.porcupine/agent/porcupine-debug.log`:
