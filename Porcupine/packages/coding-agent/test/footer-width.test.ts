import { visibleWidth } from "@porcupineai/tui";
...
describe("FooterComponent width handling", () => {
	...
	it("uses the canonical emoji-form interaction badge beside the model", () => {
		const session = createSession({
			sessionName: "",
		...
		expect(stripAnsi(footer.render(120)[1])).toContain("🛡️  Normal");
	});
});
