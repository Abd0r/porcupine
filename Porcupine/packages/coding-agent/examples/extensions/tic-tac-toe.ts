...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@porcupineai/coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@porcupineai/tui";
