import { uuidv7 } from "@porcupineai/ai";
import { complete, getModel } from "@porcupineai/ai/compat";
import type { ExtensionAPI, ExtensionCommandContext } from "@porcupineai/coding-agent";
import { DynamicBorder, getMarkdownTheme } from "@porcupineai/coding-agent";
import { Container, Markdown, matchesKey, Text } from "@porcupineai/tui";
