	...
	const extensionFlagsText =
		extensionFlags && extensionFlags.length > 0
			? `\n${chalk.bold("Extension CLI Flags:")}\n${extensionFlags
					...
					.join("\n")}\n`
			: "";
	console.log(`${chalk.bold(APP_TITLE)} - autonomous coding agent
...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} update [source|self|${APP_NAME}]   Update Porcupine, extensions, or model catalogs
...
${chalk.bold("Options:")}
  ...
  --offline                      Disable startup network operations (same as PORCUPINE_OFFLINE=1)
...
${chalk.bold("Environment Variables:")}
  ...
  PORCUPINE_PACKAGE_DIR            - Override package directory (for Nix/Guix store paths)
  PORCUPINE_OFFLINE                - Disable startup network operations when set to 1/true/yes
  PORCUPINE_TELEMETRY              - Override install telemetry when set to 1/true/yes or 0/false/no
  PORCUPINE_SHARE_VIEWER_URL       - Base URL for /share command
