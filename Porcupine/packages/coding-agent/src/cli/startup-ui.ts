import { ProcessTerminal, setKeybindings, type TUI, TuiMainScreen } from "@porcupineai/tui";
...
const OFFICIAL_PACKAGE_NAME = "@porcupineai/coding-agent";
const OFFICIAL_APP_NAME = "porcupine";
const OFFICIAL_CONFIG_DIR_NAME = ".porcupine";
 ...
 * - this is the official Porcupine distribution
