...
import type { AgentMessage, StreamFn } from "@porcupineai/agent-core";
import type { RetryCallbacks, RetryPolicy } from "@porcupineai/ai";
import { contentText } from "@porcupineai/ai";
import type { Model, SimpleStreamOptions, Usage } from "@porcupineai/ai/compat";
import {
	convertToLlm,
...
export function prepareBranchEntries(entries: SessionEntry[], tokenBudget: number = 0): BranchPreparation {
	...
	// Only extract from porcupine-generated summaries (fromHook !== true), not extension-generated ones
