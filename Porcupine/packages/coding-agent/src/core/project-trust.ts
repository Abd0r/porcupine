...
export type AppMode = "interactive" | "print" | "json" | "rpc" | "serve";
...
function formatProjectTrustPrompt(cwd: string): string {
	return `Trust project folder?\n${cwd}\n\nThis allows Porcupine to load ${CONFIG_DIR_NAME} settings and resources, install missing project packages, and execute project extensions.`;
}
