...
import { getCapabilities, getImageDimensions, hyperlink, imageFallback } from "@porcupineai/tui";
...
export function getTextOutput(
	...
	// Some tool results legitimately carry no content array (e.g. partial results
	// from progress callbacks). Never let that crash the render path.
