...
function getAliases(): Record<string, string> {
	...
	const piAiOauthEntry = resolveWorkspaceOrImport("ai/dist/oauth.js", "@porcupineai/ai/oauth");
	const piAiProvidersEntry = resolveWorkspaceOrImport("ai/dist/providers/all.js", "@porcupineai/ai/providers/all");

	_aliases = {
		"@porcupineai/coding-agent": piCodingAgentEntry,
		"@porcupineai/agent-core": piAgentCoreEntry,
		"@porcupineai/tui": piTuiEntry,
		"@porcupineai/ai/providers/all": piAiProvidersEntry,
