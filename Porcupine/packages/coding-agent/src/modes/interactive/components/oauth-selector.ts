import type { ApiKeyAuth, AuthCheck, OAuthAuth } from "@porcupineai/ai";
import { Container, type Focusable, fuzzyFilter, getKeybindings, Input, Spacer, TruncatedText } from "@porcupineai/tui";
