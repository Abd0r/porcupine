import { Container, getKeybindings, Spacer, Text } from "@porcupineai/tui";
		...
		if (this.step === "theme") {
			...
			this.addChild(
				new Text(
					theme.fg(
						"muted",
						"Opting in stores a tracking identifier in settings.json and enables anonymous\nusage analytics. This helps us better debug, reproduce, and resolve issues\nand bugs within Porcupine. You can observe what is shared using /privacy and make\nchanges anytime in settings.json.",
					),
					1,
					0,
				),
